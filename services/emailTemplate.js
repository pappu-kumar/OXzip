                        ...
                        <tr>
                          <td style="font-family: sans-serif; font-size: 14px; vertical-align: top;">
                            ...
                            <p style="font-family: sans-serif; font-size: 14px;
                             ...
                             <b>${emailFrom} has shared a file with you.</b></p>
                             <p style="font-family: sans-serif; finst-size: 14px; font-weight: normal; margin:0; Margin-bottom: 15px;">
                               <b>${size} in total. Expires in ${expires}</b>
                             </p>
                                      ...
                                      <tbody>
                                        <tr>
                                          <td style="font-family: sans-serif; font-size: 14px; vertical-align: top; background-color: #3498db; border-radius: 5px; text-align: center;">
                                           <a href="${downloadLink}" target="_blank" style="display: inline-block; color: #ffffff; background-color: #3498db; border: solid 1px #3498db; border-radius: 5px; box-sizing: border-box; cursor: pointer; text-decoration: none; font-size: 14px; font-weight: bold; margin: 0; padding: 12px 25px; text-transform: capitalize; border-color: #3498db;">
                                           Download File</a> </td>
                                        </tr>
                                      </tbody>
                                    </table>
                            ...
                            <b>Thank you for using OXzip service.</b></p>
                            <p style="font-family: sans-serif; font-size: 14px; font-weight: normal; margin: 0; Margin-bottom: 15px;">
                            <b>Your File Sharing Playground<b/></p>
                          </td>
                        </tr>
                      </table>
                    </td>
